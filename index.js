const renderTasksProgessData = (tasks) => {
  let tasksProgress;
...
const removeTask = (taskId) => {
  ...
  renderTasksProgessData(updatedTasks);
...
const getCheckboxInput = ({ id, description, checked }) => {
  ...
  checkbox.addEventListener("change", (event) => onCheckboxClick(event, id));
